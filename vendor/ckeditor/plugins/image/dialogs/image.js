                ...
                elements: [{
                    ...
                    onChange: function () {
                        ...
                        $(document).find("iframe").each(function(){
                            ...
                            if(title=='上传到服务器'){
                                $form = $(this).contents().find("form").first();
                                action = $form.attr("action");
                            }
                        });
                        if(this.isChanged()){
                            $form.attr("action",action+"&watermark=1");
                        }else{
                            $form.attr("action",action+"&watermark=0");
                        }
                    }
                },{
                    type: "checkbox",
                    ...
                    onChange: function () {
                        ...
                        if(this.isChanged()){
                            $form.attr("action",action+"&watermark=2");
                        }else{
                            $form.attr("action",action+"&watermark=0");
                        }
                    }
                    ...
                    onChange: function () {
                        ...
                        if(this.isChanged()){
                            $form.attr("action",action+"&watermark=3");
                        }else{
                            $form.attr("action",action+"&watermark=0");
                        }
                    }
                    ...
                    onChange: function () {
                        ...
                        if(this.isChanged()){
                            $form.attr("action",action+"&watermark=4");
                        }else{
                            $form.attr("action",action+"&watermark=0");
                        }
                    }
