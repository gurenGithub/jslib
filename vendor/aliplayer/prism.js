...
prism.defaultOpt = {
	...
	swfWaterMark:"",					// swf水印配置 http://taobao.com/wm.swf||BR||11123 以||分割url||对齐方式||参数
...
var Monitor = oo.extend({
    ...
    _log: function(eventType, extCfg) {
        ...
        */
        ...
        IO.jsonp(url + '?' + params, function(){ console.log(url + "?" + params)}); 
    },
...
//通过url加载视频
Player.prototype.loadByUrl=function(url) {
    this._options.vid=0;
