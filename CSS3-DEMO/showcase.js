webpackJsonp([15], {
        ...
        var s = i(8)
          ...
          , u = o.extend({
            ...
            _bindEvents: function() {
                this.listenTo(r, "drawer:close", this._teardown),
                this.listenTo(r, "drawerform:validation", this._updateCompleteStatus)
            },
            _updateCompleteStatus: function(e) {
                this.set("complete", e.status)
            },
            _teardown: function() {
                this.fieldValidation.remove(),
                this.imageUpload.remove(),
                this.errortags.remove()
            },
        ...
        var s = i(8)
          ...
          , _ = a.extend({
            ...
            onImageUploadClick: function(e) {
                ...
                if (this.imageUploadEl = s(".image-upload-input"),
                this.imagePreviewEl = s(".image-upload-preview"),
                t.files && t.files[0]) {
                    if (t.files[0].size > l)
                        return r.trigger("drawerform:errortag:show", {
                    ...
                    i.onload = o.bind(function(e) {
                        this.imagePreviewEl.removeClass("hidden"),
                        e.target.result && e.target.result.length ? (this.imagePreviewEl.find("img").attr("src", e.target.result),
                        this.imagePreviewEl.addClass("shown")) : this.imageUploadEl.removeClass("hidden")
                    }, this)
                }
            },
            onRemoveImageClick: function() {
                var e = s(".image-upload-input input");
                e.replaceWith(e.val("").clone(!0)),
                s(".image-upload-input input").trigger("change"),
                this.imagePreviewEl.removeClass("shown"),
                this.imageUploadEl.removeClass("hidden")
            }
        });
        e.exports = _
    },
          ...
          , c = a.extend({
            ...
            validateAllFields: function() {
                ...
                o.each(e, function(e) {
                    var i = s(e)
                      ...
                      , n = i.val()
                      , a = i.prop("required");
                    return this.isFieldValid(n, o, a) ? void 0 : (t = !1,
                    !1)
                }, this),
                r.trigger("drawerform:validation", {
                    status: t
                })
            },
            fieldValidationHandler: function(e) {
                var t = s(e.target)
                  ...
                  , a = t.prop("required");
                this.isFieldValid(i, o, a) ? (t.hasClass("error") && t.removeClass("error"),
                r.trigger("drawerform:errortag:remove", {
                    field: t
                }),
                "focusout" === e.type && "url" === o && i.length && 0 !== i.indexOf("http") && s(e.target).val("http://" + i)) : "focusout" === e.type && (t.addClass("error"),
                r.trigger("drawerform:errortag:show", {
                    field: t,
    ...
    1220: function(e, t, i) {
        ...
        var s = i(8)
          ...
          , c = r.extend({
            ...
            initialize: function(e) {
                this.set("mobileMode", "undefined" != typeof e && e.mobileMode ? e.mobileMode : !1),
                this.errorTags = {},
                this.listenTo(l, "drawerform:errortag:show", this.showErrorTag),
                this.listenTo(l, "drawerform:errortag:remove", this.removeErrorTag),
                this.listenTo(l, "drawerform:errortag:removeall", this.removeAllErrorTags)
            },
            showErrorTag: function(e) {
                if ("undefined" != typeof e && e.field) {
                    var t = e.field
                      ...
                      , a = t.attr("name");
                    if (!this.errorTags[a])
                        if (this.errorTags[a] = s("<div>").addClass("drawer-error-tag").text(i),
                        this.get("mobileMode")) {
                            this.groupName && this.labelName || (this.formClass = t.parents(".form").parent().attr("class"),
                            "help-form" === this.formClass ? (this.groupName = ".form-group",
                            this.labelName = ".group-label") : "abuse-form" === this.formClass && (this.groupName = ".form-row",
                            this.labelName = ".row-label"));
                            var r = t.parents(this.groupName)
                              , l = r.find(this.labelName);
                            this.errorTags[a].addClass(a).appendTo(l),
                            _.animate(this.errorTags[a], "fadeIn", {
                                duration: 100,
                                easing: "easeInOut"
                            }),
                            ...
                            "undefined" == typeof this.drawer && (this.$drawer = s(".drawer"),
                            this.$drawer.on("scroll", o.bind(this.updateErrortagPosition, this))),
                            this.errorTags[a].css({
                                top: t.offset().top,
                                right: this.$drawer.width()
                            }).insertAfter(this.$drawer),
                            _.animate(this.errorTags[a], {
                                translateX: ["-5px", "0px"]
                            }, {
                                duration: 100,
                                easing: "easeInOut"
            ...
            remove: function() {
                return this.removeAllErrorTags(),
                "undefined" != typeof this.$drawer && this.$drawer.off("scroll", o.bind(this.updateErrortagPosition, this)),
    ...
    1308: function(e, t, i) {
        ...
        var s = i(8)
          ...
          , r = n.extend({
            ...
            render: function() {
                return this.data && (o.extend(this.data, this.options),
                (this.data.has_app || "app-gate" === this.options.type) && (this.bannerView = new a(this.data).render().el,
                s(this.options.attachTo).append(this.bannerView))),
                this
            }
        });
        e.exports = r
        ...
        var s = i(3)
          ...
          , p = o.extend({
            ...
            setCookie: function() {
                ...
                n.set("hide_download_app_prompt", "1", e)
            },
            showBanner: function() {
            ...
            getMajorIosVersion: function() {
                ...
                return this.isIos() && e && 2 === e.length && e[1] ? parseInt(e[1], 10) : !1
            },
            ...
            openInAppOrStore: function(e) {
                ...
                i.setAttribute("id", "app_protocol_check"),
            ...
            initialize: function(e) {
                ...
                this.$el.addClass(this.get("type")),
                "app-gate" === this.get("type") ? this.get("has_app") ? this.subViews.bannerInternals = new u(e) : this.subViews.bannerInternals = new d(e) : this.subViews.bannerInternals = new c(e)
            },
            render: function() {
    ...
    1310: function(module, exports, __webpack_require__) {
        ...
        module.exports = Function(_keys(_imports), "return " + function(obj) {
            ...
            var __p = ""
              , __e = _.escape;
            with (obj)
                __p += '<div class="mobile-banner banner-context-dashboard ' + __e(banner_class) + '"><div class="mobile-banner-inner"><div class="mobile-banner-full"><div data-subview="bannerInternals"></div></div></div></div>';
            return __p
        }
    ...
    1311: function(e, t, i) {
        ...
        var s = i(3)
          ...
          , r = o.extend({
            ...
            render: function() {
                return this.set("install_url", this.get("install_url").replace("campaign_name", "mobile_banner_dashboard")),
                this.set("open_url", this.get("open_url") + "&referrer=mobile_banner_dashboard"),
                this.$el.html(this.template(this.toJSON())),
                this
            }
        });
    ...
    1313: function(e, t, i) {
        ...
        var s = i(3)
          ...
          , r = o.extend({
            ...
            render: function() {
                return this.set("install_url", this.get("install_url") + "?referrer=mobile_gate"),
                this.set("open_url", this.get("open_url") + "&referrer=mobile_gate"),
                this.$el.html(this.template(this.toJSON())),
                this
            }
        });
    ...
    1316: function(module, exports, __webpack_require__) {
        ...
        module.exports = Function(_keys(_imports), "return " + function(obj) {
            ...
            var __p = ""
              , __e = _.escape;
            with (obj)
                __p += '<div class="mobile-banner-body"><span class="mobile-banner-heading">' + __e(__("Want to see more stuff?")) + '</span></div><div class="mobile-banner-controls"><a href="/register" class="mobile-banner-button signup primary-cta tx-button blue">' + __e(__("Sign up")) + '</a><a href="/login" class="mobile-banner-button login secondary-cta tx-button white">' + __e(__("Log in")) + "</a></div>";
            return __p
        }
        .toString()).apply(void 0, _values(_imports))
    },
    1438: function(e, t, i) {
        ...
        var s = i(8)
          ...
          , c = n.extend({
            ...
            initialize: function() {
                this.drawerManager = r(),
                this.bindEvents()
            },
            bindEvents: function() {
                this.listenTo(a, "helpform:open", this.open),
                this.listenTo(a, "helpform:close", this.close),
                this.listenTo(this.drawerManager, "open:helpform", this.openEventHandler),
                this.listenTo(this.drawerManager, "open:helpform:terminated", o.partial(this.openEventHandler, {
                    category: "terminated"
                })),
            ...
            close: function() {
                ...
                a.trigger("helpform:closed")
            },
            openEventHandler: function(e) {
                this.open(e),
                a.trigger("helpform:opened:withButton")
            },
            open: function(e) {
          ...
          , f = m.extend({
            ...
            initialize: function(e) {
                try {
                    ...
                    this.set("suggestionsShown", !1),
                    this.on("change:complete", this.updateSubmitButton),
                    this.set("wasFormTouched", !1),
                    this.set("wasFaqLoaded", !1),
                    this.set("mobileMode", e.mobileMode || !1),
                    a.on("drawer:close", o.bind(this.teardown, this));
                    var t = n.get("Components/HelpForm");
                    this.templateAttributes.email = t.email,
                    this.templateAttributes.tumblelogs = t.tumblelogs,
                    this.templateAttributes.languageNotice = t.language_notice,
                    this.templateAttributes.categories = t.category_opt,
                    ...
                    r.bool("static_help_form") && (s(".contact_button_static").remove(),
            ...
            dismissForm: function() {
                this.logEvent("foundItClicked"),
                this.get("mobileMode") ? "undefined" != typeof window.history && window.history.length > 2 ? window.history.go(-1) : window.location = "/dashboard" : a.trigger("helpform:close")
            },
            setUpResponseHandler: function() {
                window.help_modal = {},
                window.help_modal.evaluate_response = o.bind(function(e) {
            ...
            prepareFaqIndex: function(e) {
                ...
                "undefined" != typeof e && e.length > 0 && o.each(e, function(e) {
                    o.each(e.keywords.split(","), function(i) {
                        this.faqList[e.id] = {},
                        this.faqList[e.id].question = e.question,
                        this.faqList[e.id].answer = e.answer,
                        t = e.question.match('(https?://[^"]+)'),
                        this.faqList[e.id].faqLink = null !== t ? t[0] : !1,
                        "undefined" == typeof this.keywordIndex[i] && (this.keywordIndex[i] = []),
                        this.keywordIndex[i].push(e.id)
                    }, this)
                }, this),
                this.set("wasFaqLoaded", !0)
            },
            ...
            onRequestSuccess: function() {
                ...
                a.trigger("drawer:disableCloseConfirmation"),
                setTimeout(function() {
                    a.trigger("helpform:close")
                }, 5e3)
            },
            onRequestFail: function(e) {
                var t = s(this.get("suggestionsShown") ? ".help-form-submit" : ".help-form-next")
                  ...
                  , n = s(".error-message");
                n && n.remove(),
                e.response && e.response.errors && o.extend(i, e.response),
                s(this.templates.errorMessage(i)).insertBefore(t.closest(".form-group")),
                t.removeClass("loading"),
                this.logEvent("submit:error", {
                    error: e
                })
            },
            onFormNextClick: function(e) {
                if (e.target && e.preventDefault(),
                a.trigger("drawerform:errortag:removeall"),
                !this.get("wasFaqLoaded"))
                    return this.nextFormButton.addClass("loading"),
                    void this.once("change:wasFaqLoaded", this.onFormNextClick, this);
                var t = this.getSuggestions();
                t.length > 0 ? (this.set("suggestionsShown", !0),
                this.form.addClass("not-shown"),
                this.get("mobileMode") && this.form.addClass("hidden"),
                this.$el.prepend(this.templates.suggestions(o.extend(this.templateAttributes))),
                this.fillInSuggestions(t),
                this.resetScroll(),
                this.logEvent("suggestions:found", {
                    suggestions: t
                })) : (this.form.find("form").submit(),
                this.nextFormButton.addClass("loading"),
                this.logEvent("suggestions:notfound")),
                this.sendLogQuery()
            },
            ...
            onFieldInputChange: function(e) {
                this.get("wasFormTouched") || (this.set("wasFormTouched", !0),
                a.trigger("drawer:enableCloseConfirmation"),
                this.getFaqs())
            },
            resetScroll: function() {
                var e;
                this.get("mobileMode") ? e = s("body") : ("undefined" == typeof this.drawer && (this.drawer = this.$el.closest(".drawer")),
                e = this.drawer),
                o.defer(function() {
                    e.scrollTop(0)
                })
            ...
            onFormSubmitClick: function() {
                this.form.find("form").submit(),
                this.$el.find(".help-form-submit").addClass("loading")
            },
            ...
            render: function() {
                ...
                this.bodyField = this.$el.find(".body"),
                this.categoryField = this.$el.find(".category"),
                this.nextFormButton = this.$el.find(".help-form-next"),
                this.setUpSelector(this.$el.find(".category")),
                this.setUpSelector(this.$el.find(".tumblelog")),
                this
            },
            teardown: function() {
    ...
    1440: function(module, exports, __webpack_require__) {
        ...
        module.exports = Function(_keys(_imports), "return " + function(obj) {
            ...
            Array.prototype.join;
            with (obj)
                __p += '<div class="form-container form"><div class="form-header with-border"><h1 class="form-heading">' + (null == (__t = __("Help me, Tumblr")) ? "" : __t) + '</h1><div class="form-description"><p> ' + (null == (__t = __("You got it. Describe the problem you're having as best you can, and a member of our Support team will be in touch with you as soon as possible.")) ? "" : __t) + " </p><br><p> " + (null == (__t = __("%1$sNote:%2$s This form is for technical issues and general weirdness. If you're reporting a violation of our Community Guidelines, use %3$sthis other form%4$s instead.", "<strong>", "</strong>", '<a href="/abuse">', "</a>")) ? "" : __t) + ' </p></div></div><form action="/support/ticket/new" src="" method="POST" enctype="multipart/form-data" target="help_form_target"><iframe id="help_form_target" name="help_form_target" style="width:0;height:0;border:none;margin:0;padding:0"></iframe><input type="hidden" name="jsonp" value="help_modal.evaluate_response"> <input type="hidden" name="support_type" id="support_form_support_type" value="support"> <input type="hidden" name="form_key" id="support_form_form_key" value="' + (null == (__t = formKey) ? "" : __t) + '"> ',
                languageNotice && (__p += ' <div class="form-group"><div class="group-row"><span class="language-notice">' + (null == (__t = __("Just so you know, we're not yet able to address queries that are written in [language]. You can still use this form to contact our Support team, but you'll need to fill it out in English. Sorry about that, and thanks for your patience.")) ? "" : __t) + "</span></div></div> "),
                __p += ' <div class="form-group"><div class="group-label"><h3 class="settings_subheading">' + (null == (__t = __("What's going on?")) ? "" : __t) + '</h3></div><div class="group-content"><div class="flat_select attached"> ',
                preSelectedCategory ? (__p += ' <select aria-label="' + __e(__("Select a category for the problem you are experiencing")) + '" name="subject" id="category" class="category" data-validate-input="dropdown"><option value="' + (null == (__t = __("Category")) ? "" : __t) + '" disabled="disabled">' + (null == (__t = __("Category")) ? "" : __t) + "</option> ",
                _.each(categories, function(e, t) {
                    __p += " ",
                    __p += t === preSelectedCategory ? ' <option value="' + (null == (__t = t) ? "" : __t) + '" selected="selected">' + (null == (__t = __(e)) ? "" : __t) + "</option> " : ' <option value="' + (null == (__t = t) ? "" : __t) + '">' + (null == (__t = __(e)) ? "" : __t) + "</option> ",
                    __p += " "
                }),
                __p += ' </select><label aria-hidden="true" for="category" class="current_selection">' + (null == (__t = categories[preSelectedCategory]) ? "" : __t) + "</label> ") : (__p += ' <select aria-label="' + __e(__("Select a category for the problem you are experiencing")) + '" name="subject" id="category" class="category" data-validate-input="dropdown" required><option value="' + (null == (__t = __("Category")) ? "" : __t) + '" disabled="disabled" selected="selected">' + (null == (__t = __("Category")) ? "" : __t) + "</option> ",
                _.each(categories, function(e, t) {
                    __p += ' <option value="' + (null == (__t = t) ? "" : __t) + '">' + (null == (__t = __(e)) ? "" : __t) + "</option> "
                }),
                __p += ' </select><label aria-hidden="true" for="category" class="current_selection">' + (null == (__t = __("Category")) ? "" : __t) + "</label> "),
                __p += ' <i aria-hidden="true" class="icon"></i></div><textarea aria-label="' + __e(__("Please provide some information about the problem")) + '" class="body" data-validate-input="text" required name="body" cols="30" rows="5" placeholder="' + (null == (__t = __("The more details, the better")) ? "" : __t) + '"></textarea></div></div> ',
                supportsFileChooser && (__p += ' <div class="form-group"><div class="group-label"><h3 class="settings_subheading">' + (null == (__t = __("Attachment")) ? "" : __t) + '</h3><div class="sub-label">' + (null == (__t = __("Optional")) ? "" : __t) + '</div></div><div class="group-content"><div class="image-upload-input"><input aria-label="' + __e(__("Please upload any screenshots that might be relevant")) + '" id="image-upload" class="image-upload" type="file" name="attachments[]" accept="image/*"><label aria-hidden="true" class="image-upload" for="image-upload"></label></div><div class="image-upload-preview"><img title="' + __e(__("Uploaded image")) + '" src=""> <button aria-label="' + __e(__("Remove image")) + '" class="btn_remove btn-remove-uploaded" data-tooltip="' + (null == (__t = __("Remove image")) ? "" : __t) + '"></button></div></div></div> '),
                __p += ' <div class="form-group"><div class="group-label"><h3 class="settings_subheading">' + (null == (__t = __("Relevant blog")) ? "" : __t) + '</h3><div class="sub-label">' + (null == (__t = __("Optional")) ? "" : __t) + '</div></div><div class="group-content"> ',
                tumblelogs && _.size(tumblelogs) >= 1 ? (__p += ' <div class="flat_select"><select aria-label="' + __e(__("Please select the blog that has the problem, if applicable")) + '" name="support_form_blog" id="tumblelog" class="tumblelog"><option value="" selected="selected">' + (null == (__t = __("None selected")) ? "" : __t) + "</option> ",
                _.each(tumblelogs, function(e) {
                    __p += ' <option value="' + __e(e.name) + '">' + __e(e.name) + "</option> "
                }),
                __p += ' </select><label aria-hidden="true" for="tumblelog" class="current_selection">' + (null == (__t = __("None selected")) ? "" : __t) + '</label><i aria-hidden="true" class="icon"></i></div> ') : __p += ' <input aria-label="' + __e(__("Please let us know which blog has the problem, if applicable")) + '" class="text_field" name="support_form_blog" placeholder="' + (null == (__t = __("Username or URL")) ? "" : __t) + '"> ',
    ...
    1442: function(module, exports, __webpack_require__) {
        ...
        module.exports = Function(_keys(_imports), "return " + function(obj) {
            ...
            var __t, __p = "";
            with (obj)
                __p += '<div class="form-container success"><div class="success-message"><h1 class="message-title"> ' + (null == (__t = __("Got it")) ? "" : __t) + ' </h1><p class="message-text"> ' + (null == (__t = __("Our Support team will be emailing you shortly.")) ? "" : __t) + " <br> " + (null == (__t = __("And thanks for bringing this thing to our attention.")) ? "" : __t) + " </p></div></div>";
            return __p
        }
        .toString()).apply(void 0, _values(_imports))
    },
    1443: function(module, exports, __webpack_require__) {
        ...
        module.exports = Function(_keys(_imports), "return " + function(obj) {
            ...
            Array.prototype.join;
            with (obj)
                __p += '<div class="error-message"><div class="error-text"> ',
                errors ? (__p += " ",
                _.each(errors, function(e) {
                    __p += " <div>" + __e(e.error) + "</div> "
                }),
                __p += " ") : __p += " " + (null == (__t = __("Oops. There was an error. Try again.")) ? "" : __t) + " ",
                __p += " </div></div>";
            return __p
        }
        .toString()).apply(void 0, _values(_imports))
    ...
    1444: function(module, exports, __webpack_require__) {
        ...
        module.exports = Function(_keys(_imports), "return " + function(obj) {
            ...
            var __t, __p = "";
            with (obj)
                __p += '<div class="question">' + (null == (__t = question) ? "" : __t) + '</div><div class="answer">' + (null == (__t = answer) ? "" : __t) + "</div>";
            return __p
        }
        .toString()).apply(void 0, _values(_imports))
    },
        ...
        var s = i(8)
          ...
          , h = n.extend({
            ...
            _createAboutTumblr: function(e) {
                ...
                a.on("abouttumblr:change", o.bind(this.__aboutTumblrChange, this)))
            },
            initialize: function() {
                this.helpForm = new r,
                this.headerView = new c;
                var e = s("body");
                this.isMobile = e.hasClass("is_mobile"),
                this.isLoggedIn = e.hasClass("logged_in"),
                !this.isLoggedIn && this.isMobile && (this.mobileAppBanner = new d({
                    type: "download-banner",
            ...
            register: function() {
                this._createAboutTumblr(!1),
                p.bool("discovery_hub_access") && (this.exploreButton = new u({
                    el: s(".signup_forms")
                }))
            },
            login: function() {
        ...
        var s = i(8)
          ...
          , l = n.extend({
            ...
            __logoClick: function(e) {
                0 !== this.defaults.activeSlideIndex && e.preventDefault(),
                this.showcaseView.setSection(0)
            },
            ...
            __aboutTumblrChange: function(e, t) {
                this.defaults.activeSlideIndex = e,
                this.$lastSlideInput.length && 0 !== e && this.$lastSlideInput.val(t)
            },
            initialize: function(e) {
                this.options = o.extend({}, this.defaults, e),
                this.$lastSlideInput = s("#about_tumblr_slide"),
                this.showcaseView = new r({
                    componentData: this.getOwnData()
                }),
                this.listenTo(a, "loggedoutheader:logoclick", this.__logoClick),
                this.listenTo(a, "abouttumblr:change", this.__aboutTumblrChange),
                this.options.isLogin ? this.listenTo(a, "loggedoutheader:loginclick", this.__signupClick) : this.listenTo(a, "loggedoutheader:signupclick", this.__signupClick)
            },
            render: function() {
                return this.showcaseView.render(),
                this
            },
            remove: function() {
                return this.showcaseView.teardown(),
                this
            }
        });
        e.exports = l
        ...
        var s = i(8)
          ...
          , d = n.extend({
            ...
            __mousewheel: function(e) {
                ...
                return 0 > t ? this.nextSection() : this.previousSection(),
                !1
            },
            ...
            _setActiveSection: function() {
                ...
                this.$sections.eq(this.activeSectionIndex).addClass("active"),
            ...
            initialize: function(e) {
                ...
                this.$html = s("html"),
                this.$body = s("body"),
                this.$header = s(".logged-out-header"),
                this.$logo = s("#logo"),
                ...
                this.sectionViews = {},
                this.componentData = this.options.componentData,
                this.slideshowHeight = 1.2 * r.rect().windowHeight,
                this.activeSlideTimeout = null,
            ...
            setSection: function(e) {
                ...
                e !== this.activeSectionIndex && t.length && (0 !== this.activeSectionIndex && this.activeSectionIndex !== t.length && 0 !== e && e !== t.length || this.$el.addClass("animating"),
                this._unsetActiveSection(),
                this.activeSection = t.data("section"),
                this.activeSectionIndex = e,
                this.activeSectionView = this.sectionViews[this.activeSection],
                this.isScrolling = !0,
                this.paginationView.update(e),
                this.$sections.removeClass("old-hat").filter(":lt(" + this.activeSectionIndex + ")").addClass("old-hat"),
                this.activeSlideTimeout && (clearTimeout(this.activeSlideTimeout),
                this.activeSlideTimeout = null),
                this.scrollTimeout && (clearTimeout(this.scrollTimeout),
                this.scrollTimeout = null),
                this.activeSlideTimeout = setTimeout(o.bind(function() {
                    this._resetScrolling(),
                    this._setActiveSection()
                }, this), this.options.scrollSpeed),
                a.trigger("abouttumblr:change", this.activeSectionIndex, this.activeSection),
            ...
            render: function() {
                ...
                return this.$el.on("wheel mousewheel", e),
                a.trigger("abouttumblr:start", this.activeSectionIndex),
                this
            },
            teardown: function() {
                return a.trigger("abouttumblr:remove"),
                o.each(this.sectionViews, function(e) {
                    e.remove()
                }),
                this.$html.removeClass("show-about-tumblr"),
                this.$logo.off(".about-tumblr"),
                this.$el.off(),
                this.remove(),
                this
            }
        ...
        var s = i(8)
          ...
          , r = a.extend({
            ...
            initialize: function(e) {
                ...
                this.$graphic = this.$(".about-graphic")
            },
            showSlide: function() {
                ...
                a.prototype.showSlide.call(this, arguments)
            }
        });
        e.exports = r
    },
        ...
        var s = i(3)
          ...
          , n = o.extend({
            initialize: function(e) {
                ...
                this.componentData = this.options.componentData,
                this.slideName = this.options.slideName,
                this.slideIndex = this.options.slideIndex,
                this.$wrapper = this.$(".section-wrapper"),
                this.render()
            },
            render: function() {
                var e = this.$wrapper.length ? this.$wrapper : this.$el;
                return this.template && s.has(this.componentData, this.slideName) && e.append(this.template(this.componentData[this.slideName])),
                this
            },
            showSlide: function() {}
        });
            ...
            render: function() {
                return s.ajax({
                    ...
                    success: o.bind(function(e) {
                        this.componentData.blogs = e.response,
        ...
        var s = i(3)
          ...
          , r = o.extend({
            ...
            render: function() {
                ...
                return t.length && !s.isEmpty(e.post_top) && t.html(a(e.post_top)),
                i.length && !s.isEmpty(e.post_bottom) && i.html(a(e.post_bottom)),
                this
            }
        });
        e.exports = r
        ...
        var s = i(8)
          ...
          , a = n.extend({
            ...
            __aboutButtonClick: function(e) {
                e.preventDefault(),
                o.trigger("abouttumblr:navigate", 1)
            },
            initialize: function(e) {
                n.prototype.initialize.call(this, e),
                this.$emailInput = s("#signup_email")
            },
            showSlide: function() {
        ...
        var s = i(8)
          ...
          , l = n.extend({
            ...
            __dotClick: function(e) {
                e.preventDefault();
                var t = s(e.currentTarget);
                t.hasClass("active") || (this.$dots.removeClass("active"),
                t.addClass("active"),
                a.trigger("abouttumblr:navigate", t.index()))
            },
            initialize: function(e) {
                this.options = o.extend({}, this.defaults, e),
                this.$dots = s()
            ...
            update: function(e) {
                ...
                this.$dots.eq(e).addClass("active")
            }
        });
        e.exports = l
    },
    ...
    1473: function(e, t, i) {
        ...
        var s = i(155)
          ...
          , l = s.extend({
            ...
            template: r,
            initialize: function(e) {
                this.formComponent = new o(e),
                this.formContainer = this.subviews.formContainer = this.formComponent.view,
                e.mobileMode || (this.namePickerComponent = new n(e),
                this.namePicker = this.subviews.namePicker = this.namePickerComponent.view),
                this.subviews.confetti = new a({
                    amount: 30,
                    autoParty: !0,
                ...
                this.listenTo(this.formContainer, "form:username:empty", this.displayNamePicker),
                this.listenTo(this.formContainer, "form:username:notempty", this.hideNamePicker),
                this.listenTo(this.formContainer, "form:list:usernames", this.refreshNamePicker),
                this.listenTo(this.namePicker.view, "namePicker:clickItem", this.onClickUsername))
            },
            refreshNamePicker: function(e) {
                this.namePicker.view.refreshView(e),
                this.displayNamePicker()
            },
            onFocusListener: function() {
                this.formContainer.isUsernameEmpty() && (this.displayNamePicker(),
                this.formContainer.insertNameInField(this.namePicker.view.getFirstName()))
            },
            ...
            onClickUsername: function(e) {
                this.hideNamePicker(),
                this.formContainer.insertNameInField(e)
            }
        });
        e.exports = l
    },
    ...
    1475: function(e, t, i) {
        ...
        var s = i(155)
          ...
          , r = s.extend({
            ...
            initialize: function(e) {
                this.formKey = e.formKey,
                this.maxUsernameLength = e.maxUsernameLength,
                this.model = new a,
            ...
            submitToValidation: function() {
                ...
                var e = {};
                e.username = this.getUsernameVal(),
                e.formKey = this.formKey,
                this.model.trigger("form:validation", e)
            },
            ...
            cacheSelectors: function() {
                this.$username = this.$("#signup_username"),
                this.$form = this.$("#form"),
                this.$errorTag = n("<div>", {
                    "class": "error"
                }),
            ...
            appendError: function(e) {
                "undefined" != typeof e && (this.$errorTag.html(e),
                this.$errorTag.insertBefore(this.$submitButton).css("display", "block"))
            },
            stateForm: function(e) {
                e.reject_reason && this.appendError(e.reject_reason),
                e.usernames && this.trigger("form:list:usernames", e.usernames)
            },
        ...
        var s = i(8)
          ...
          , a = n.extend({
            ...
            validation: function(e) {
                var t = {};
                this.username = t.username = e.username,
                this.formKey = e.formKey,
                t.username.length && (this.pw_xhr && this.pw_xhr.abort(),
                this.pw_xhr = s.ajax({
                    url: this.url,
                    dataType: "json",
                    type: "POST",
                ...
                this.pw_xhr.done(o.bind(function(e) {
                    this.stateForm(e.response),
                    delete this.pw_xhr
                }, this)))
            },
            stateForm: function(e) {
                e.reject_reason ? (this.set("usernameValid", !1),
                this.set("errorMessage", e.reject_reason)) : this.save(),
                this.trigger("form:state", e)
            },
            save: function() {
                var e = {};
                e["tumblelog[name]"] = this.username,
                e.form_key = this.formKey,
                e.page = "tumblelog",
                ...
                this.save_xhr.done(o.bind(function(e) {
                    window.location.href = "/getting_to_know_tumblr",
                    delete this.save_xhr
                }, this)))
            }
        });
        e.exports = a
        ...
        var s = i(8)
          ...
          , a = o.extend({
            ...
            render: function() {
                ...
                this.$wrapper = s("<div />").addClass("popover-inner popover_inner").appendTo(this.$el),
                this.$wrapper.html(this.view.render().$el),
                this
            },
            getView: function() {
                return this.view
        ...
        var s = i(155)
          ...
          , r = s.extend({
            ...
            initialize: function(e) {
                ...
                this.randomUsernames = e.randomUsernames
            },
            render: function() {
                return this.$el.html(this.template({
            ...
            clickOnItem: function(e) {
                ...
                e.preventDefault(),
                n.isEmpty(i) || this.trigger("namePicker:clickItem", i)
            },
    ...
    1481: function(module, exports, __webpack_require__) {
        ...
        module.exports = Function(_keys(_imports), "return " + function(obj) {
            ...
            Array.prototype.join;
            with (obj)
                _.each(randomUsernames, function(e) {
    ...
    1487: function(module, exports, __webpack_require__) {
        ...
        module.exports = Function(_keys(_imports), "return " + function(obj) {
            ...
            var __t, __p = "";
            with (obj)
                __p += '<a class="explore" href="/explore"><span class="explore_icon"></span>' + (null == (__t = __("Here's what's trending")) ? "" : __t) + "</a>";
            return __p
        }
        .toString()).apply(void 0, _values(_imports))
    },
